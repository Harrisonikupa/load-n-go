                        ...
                        child: model.orders.length > 0
                            ? ListView.builder(
                                ...
                                itemBuilder: (context, index) => OrderItem(
                                  tap: () =>
                                      model.selectOrders(model.orders[index]),
                                  customerName:
                                  ...
                                  pickupLocation:
                                      model.orders[index].pickupAddress,
                                  deliveryDate:
                                      model.orders[index].deliveryDate,
                                  deliveryLocation:
                                      model.orders[index].deliveryAddress,
                                  weightOfOrder:
                                      model.orders[index].weightOfOrder,
                                  quantity:
                                      model.orders[index].quantity.toString(),
